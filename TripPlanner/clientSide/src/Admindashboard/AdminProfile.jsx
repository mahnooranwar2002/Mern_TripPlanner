        ...
        <h2 className="form-title">Update Profile</h2>
         <div className="text-center mb-3">
               { reg.profile_picture? (
                  ...
                  <img src={`/images/${reg.profile_picture}`} alt="User" width={60} height={60} className="rounded-circle m-2" />
                ) : (
              <img src="https://cdn4.iconfinder.com/data/icons/small-n-flat/24/user-512.png" alt="Default" width={60} height={60} />
                )}
              </div>
